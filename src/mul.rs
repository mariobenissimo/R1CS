...
// proving I know AT and BT which the mul is equal to CT
// CT = input
// AT BT = witness 
...
impl<I, IV> Clone for MulVerificaion<I, IV>
where
    I: Pairing,
    IV: PairingVar<I>,
{
...
impl<I, IV> ConstraintSynthesizer<<I as Pairing>::BaseField> for MulVerificaion<I, IV>
where
    I: Pairing,
    IV: PairingVar<I>,
...
mod test_groth {
    ...
    fn test_prove_and_verify() {
        let mut rng = ark_std::test_rng();
        let circuit = MulVerificaion::<I, IV>::new(&mut rng);
